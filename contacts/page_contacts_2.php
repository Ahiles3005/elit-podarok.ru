	...
	<div class="row">
		<div class="<?=($bUseMap ? 'col-md-4' : 'col-md-12')?>">
			<div style="font-weight: bold;margin-bottom: 1em;">
                <span itemprop="name"><?$APPLICATION->IncludeFile(SITE_DIR."include/contacts-site-name.php", Array(), Array("MODE" => "html", "NAME" => "Site name"));?></span>
            </div>
            <div>
			...
			<table>
				<tbody>
                    ...
                    <tr class="print-6">
                        <td align="left" valign="top"><i class="fa big-icon  fa-whatsapp"></i></td><td align="left" valign="top"> <span class="dark_table">Whatsapp</span>
                            <br />
                            <span><?$APPLICATION->IncludeFile(SITE_DIR."include/contacts-site-whatsapp.php", Array(), Array("MODE" => "html", "NAME" => "Whatsapp"));?></span>
                        </td>
                    </tr>
					<tr class="print-6">
