...
$APPLICATION->SetPageProperty("title", "Справочная информация | Элитные Подарки");
$APPLICATION->SetPageProperty("description", "Справочная информация для посетителей интернет-магазина Элитные Подарки.");
