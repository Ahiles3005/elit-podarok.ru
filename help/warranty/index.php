...
$APPLICATION->SetPageProperty("title", "Гарантия на товар | Элитные Подарки");
$APPLICATION->SetPageProperty("description", "Условия предоставления гарантии на товар приобретённый в интернет-магазине \"Элитные Подарки\".");
