...
$APPLICATION->SetPageProperty("description", "Соглашение на обработку персональных данных в интернет-магазине Элитные Подарки.");
$APPLICATION->SetPageProperty("title", "Соглашение на обработку персональных данных | Элитные Подарки");
