...
//begin
/*$db_list = CIBlockSection::GetList(Array("SORT" => "ASC"), array("IBLOCK_ID" => $this->IBLOCK_ID), true);
while($ar_result = $db_list->GetNext())
{
    $db_listt[] = $ar_result["ID"];
}

//echo "<pre>"; print_r($db_listt); echo "</pre>";
...
//echo "<pre>"; print_r($topfilter); echo "<pre>";
//end
*/
if(isset($_REQUEST["ajax"]) && $_REQUEST["ajax"] === "y")
{
