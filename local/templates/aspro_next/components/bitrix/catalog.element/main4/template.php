...
<div class="item_main_info type_clothes <?=(!$showCustomOffer ? "noffer" : "");?> <?=($arParams["SHOW_UNABLE_SKU_PROPS"] != "N" ? "show_un_props" : "unshow_un_props");?>" id="<?=$arItemIDs["strMainID"];?>">
	...
	<div class="right_info">
		<div class="info_item">
			...
			<?$frame = $this->createFrame()->begin();?>
				...
				<div class="prices_block">
					...
					<div class="quantity_block_wrapper">
						...
						<?}?>
						<p style="font-size: 13px; margin: 1em 0">Нанесение гравировки бесплатно.</p>
			...
			<?$frame->end();?>
                <div class="row toggle_block">
                    <div class="col-xs-12">
                        <section class="toggle">
                            <label><?/*<i class="fa fa-minus"></i><i class="fa fa-plus"></i>*/?>Способы оплаты</label>
                            <div class="toggle-content" style="display: none;">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="payment_block" style="margin-top: 0">
                                            <span class="mir"></span>
                        ...
                        <section class="toggle">
                            <label><?/*<i class="fa fa-minus"></i><i class="fa fa-plus"></i>*/?>Информация о доставке</label>
                            <div class="toggle-content" style="display: none;">
                                <ul>
                                    <li>Пешим курьером в будние и выходные дни, по предварительной договоренности с заказчиком</li>
                                    <li>Возможность быстрой доставки в день заказа после его подтверждения</li>
                                    <li>Услуга самовывоза действует в течении 3-х дней с момента подтверждения заказа</li>
                                </ul>
                                В зависимости от места жительства вам предложат варианты доставки. Выберите любой удобный способ.
                            </div>
                        </section>
                        <section class="toggle">
                            <label><?/*<i class="fa fa-minus"></i><i class="fa fa-plus"></i>*/?>Ответы на вопросы</label>
                            <div class="toggle-content" style="display: none;">
                                Здесь Вы найдете <a href="/info/faq/">ответы на самые частые вопросы</a>
                            </div>
                        </section>
                    </div>
                </div>
