...
$arUrlRewrite=array (
  ...
  array (
    ...
    'RULE' => 'find_section=$1',
    'ID' => 'bitrix:catalog',
    'PATH' => '/catalog/filter_include.php',
    'SORT' => 1,
  ),
  26 => 
  array (
    'CONDITION' => '#^/catalog/([\\w,-]+)/page-([0-9]+)/([\\?\\#].*)?$#',
    'RULE' => 'find_section=$1',
    'ID' => 'bitrix:catalog',
    'PATH' => '/catalog/filter_include.php',
    'SORT' => 2,
  ...
  27 => 
  array (
    'CONDITION' => '#^/([\\w\\d-_]+).html([\\?\\#].*)?$#',
    'RULE' => 'ELEMENT_CODE=$1',
    'ID' => 'bitrix:catalog',
    'PATH' => '/catalog/sef_index.php',
    'SORT' => 2,
  ),
  10 => 
  array (
